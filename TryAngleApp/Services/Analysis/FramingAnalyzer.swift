...
// ============================================================================
// 원래 용도: 레퍼런스와 현재 이미지의 프레이밍(구도) 분석
// 사용되지 않는 이유: RealtimeAnalyzer에서 인스턴스화만 되고 메서드 호출 없음
// 대체된 파일:
//   - Services/Analysis/PhotographyFramingAnalyzer.swift (사진학 기반 분석)
//   - Services/OnDevice/GateSystem.swift (Gate별 마진/포지션 분석)
//   - Services/OnDevice/MarginAnalyzer.swift (마진 전문 분석)
// 삭제 가능 여부: 가능 (메서드가 호출되지 않음)
// ============================================================================
